...
<table width="100%" border="0" id="table_style_all" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="2">
     <tr>
      <td><strong>&nbsp;产品报废报表管理</strong>&nbsp;&nbsp;<a href="report_none.php?type=day">日报表</a> | <a href="report_none.php?type=week">周报表</a> | <a href="report_none.php?type=month">月报表</a> | <a href="report_none.php?type=year">年报表</a>&nbsp;&nbsp;<input type="button" onClick="preview(1);" value=" 打印产品报废报表 "></td>
     </tr>
     <tr>
      <td bgcolor="#FFFFFF">
     <?php
	  ...
	  ?>
       <table width="100%" cellspacing="0" cellpadding="0" border="0" id="table_border">
	    <tr height="40"><form action="report_none.php?action=save&type=day" name="form1" method="post">
		 <td id="row_style" colspan="10">请选择日期&nbsp;&nbsp;<input type="text" name="sday" onclick="setday(this)" value="<?php echo ($action=='save')?$sday:GetDateMk(time());?>">(单击输入框选择报表日期)&nbsp;&nbsp;<input type="submit" value=" 显示日报表 "></td>
	    </tr>
	   <?php
	   break;
	   case 'week':
       ...
       <table width="100%" cellspacing="0" cellpadding="0" border="0" id="table_border">
	    <tr height="40"><form action="report_none.php?action=save&type=week" name="form1" method="post">
		 ...
		 echo "</select>";
		 ?>
		 &nbsp;&nbsp;<input type="submit" value=" 显示周报表 "></td>
	    </tr>
	   <?php
	   break;
	   case 'month':
...
$report_title="产品报废年报表";
break;
case "other":
$query="select * from #@__none,#@__basic where to_days(#@__none.dtime)=to_days('$sday') and #@__none.productid=#@__basic.cp_number";
$report_title="产品报废任意时间段报表";
break;
}
