...
`g_pay` VARCHAR( 20 ) CHARACTER SET gbk COLLATE gbk_chinese_ci NULL DEFAULT '0',
...
`r_date` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
`r_status` SMALLINT( 6 ) NOT NULL DEFAULT '0' ,
`r_adid` VARCHAR( 10 ) CHARACTER SET gbk COLLATE gbk_chinese_ci NOT NULL ,
`finish` SMALLINT( 6 ) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=#~lang~#; 
...
`money` VARCHAR( 15 ) CHARACTER SET gbk COLLATE gbk_chinese_ci NOT NULL ,
`mem` TEXT CHARACTER SET gbk COLLATE gbk_chinese_ci NULL,
`dtime` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=MyISAM DEFAULT CHARSET=#~lang~#; 