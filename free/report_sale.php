...
<table width="100%" border="0" id="table_style_all" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="2">
     <tr>
      <td><strong>&nbsp;销售报表管理</strong>&nbsp;&nbsp;<a href="report_sale.php?type=day">日报表</a> | <a href="report_sale.php?type=week">周报表</a> | <a href="report_sale.php?type=month">月报表</a> | <a href="report_sale.php?type=year">年报表</a>&nbsp;&nbsp;<input type="button" onClick="preview(1);" value=" 打印销售报表 "></td>
     </tr>
     <tr>
      <td bgcolor="#FFFFFF">
     <?php
...
$p_rtitle= "<tr class='row_report_head'><td>货号</td><td>名称</td><td>规格</td><td>分类</td><td>单位</td><td>售价</td><td>客户</td><td>销售单号</td><td>数量</td><td>金额</td></tr>";
