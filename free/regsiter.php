...
ViooMa进销存（PHP版）适应中小企业及个体用户使用，功能实用，操作简单，是您自动管理“进、销及存”不可缺少的帮手，唯一官方网站：http://www.viooma.com 咨询QQ：475994986 咨询电话：138731933788，注册事项及系统定制等请联系我！ */
...
ViooMa进销存（PHP版）适应中小企业及个体用户使用，功能实用，操作简单，是您自动管理“进、销及存”不可缺少的帮手，唯一官方网站：http://www.viooma.com 咨询QQ：475994986 咨询电话：138731933788，注册事项及系统定制等请联系我！ */";
	  ...
	  ViooMa进销存（PHP版）适应中小企业及个体用户使用，功能实用，操作简单，是您自动管理“进、销及存”不可缺少的帮手，唯一官方网站：<a href="http://www.viooma.com" target="_blank">http://www.viooma.com</a>&nbsp;咨询QQ：<a href="http://wpa.qq.com/msgrd?V=1&Uin=475994986&Site=ioshenmue&M">475994986</a>&nbsp;咨询电话：13873193788，注册事项及系统定制等请联系我！
	  </td>
	 </tr>
	 <?php
	 $sql=new dedesql(false);
	 ...
	 <tr>
	  <td bgcolor="#EFEFEF">
	  ViooMa进销存注册码：<input type="text" name="rkey" size="20" value="<?php echo $row['key'];?>" onclick="this.select()" readonly>
	  </td>
	 </tr>
	 <?php
	   $password='userma';
