...
check_grant('system_usertype.php',GetCookie('rank'));
if($action=='save'){
if($b_name==''){
...
<table width="100%" border="0" id="table_style_all" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="2">
     <tr>
      <td><strong>&nbsp;用户类型管理</strong>&nbsp;&nbsp;<!--<a href="system_worker.php?action=new">添加新的操作员</a> | <a href="system_boss.php">查看操作员列表</a>&nbsp;|--></td>
     </tr>
     <tr>
      <td bgcolor="#FFFFFF">
	  <?php if($action=='new'){ ?>
	   ...
	   if($rowcount==0)
	   echo "<tr><td>&nbsp;系统里还没有任何用户类型,请先<a href=system_usertype.php?action=new>添加用户类型</a>。</td></tr>";
	   else{
	   ...
	   <td><center><a href=system_usertype_edit.php?rank=".$row['rank'].">修改</a> </td></tr>";
	   $i++;
	   }
	   }
	   echo "</table>";
