...
require_once(dirname(__FILE__)."/include/checklogin.php");
		...
		?>
		最新公告：<iframe width="380" height="22" src="http://www.viooma.com/note.html" scrolling="no" frameborder="0" marginheight="0" marginwidth="0" vspace="0" hspace="0"></iframe>
		<?php
		}
		?>
		<div style="display:none;"><script language="javascript" type="text/javascript" src="http://js.users.51.la/2059281.js"></script></div></td>
        <td align="right">&nbsp;<?php echo GetCookie('VioomaUserID')."(".getusertype(GetCookie('rank'),0).")";?>&nbsp;|&nbsp;<a href="http://www.viooma.com" target="_blank">官方首页</a>&nbsp;|&nbsp;<a href="system_password.php" target="main">修改密码</a>&nbsp;|&nbsp;<a href="system_out.php" target="_top">安全退出</a></td>
       </tr>
      </table>
	 </td>
