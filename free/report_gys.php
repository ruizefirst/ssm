...
<table width="100%" border="0" id="table_style_all" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="2">
     <tr>
      <td><strong>&nbsp;供应商对帐报表</strong>&nbsp;&nbsp; 
	  <a href="report_gys.php?type=month">月报表</a> | 
	  <a href="report_gys.php?type=year">年报表</a>&nbsp;&nbsp;
	  <input type="button" onClick="preview(1);" value=" 打印供应商对帐表 ">
	  </td>
     </tr>
     <tr>
      <td bgcolor="#FFFFFF">
...
$mylist = $plist->GetDataList();
	   ...
	   <tr><td>&nbsp;&nbsp;合  计:</td><td colspan='4'>数量：".$alln."</td><td colspan='3'>金额:￥".number_format($allmoney,2,'.',',')."</td><td colspan='2'></td></tr>
	   </table>";	
